        ...
        switch (data) {
            case "Badminton": {
                ...
                rule.append("<HTML>\n" +
                        ...
                        "\n" +
                        "<p><b>1.</b> A match consists of the best of 3 games of 21 points.\n" +
                        "<br>" +
                        "<b>2.</b> Every time there is a serve .There is a point scored. \n" +
                        "<br>" +
                        "<b>3.</b> The side winning a rally adds a point to its score.\n" +
                        "<br>" +
                        "<b>4.</b> At 20 all, the side which gains a 2-point lead first, wins that game.\n" +
                        "<br>" +
                        "<b>5.</b> At 29 all, the side scoring the 30th point, wins that game.\n" +
                        "<br>" +
                        "<b>6.</b> The side winning a game serves first in the next game.</P>\n" +
                        "<br>" +
                        "<h3><b>SINGLES</b></h3>\n" +
                        "<br>" +
                        "<p><b>1.</b> At the beginning of the game (0-0) and when the server score is even, the server serves from the right service court. When the server score is odd, the server serves from the left service court.\n" +
                        "<br>" +
                        "<b>2.</b> If the server wins a rally, the server scores a point and then serves again from the alternate service court.\n" +
                        "<br>" +
                        "<b>3.</b> If the receiver wins a rally, the receiver scores a point and becomes the new server. They serve from the appropriate service court left if their score is odd, and right if it is even.\n" +
                        "<br></p>" +
                        "<h3>" +
                        "<b>DOUBLES</b></h3>" +
                        "<br>" +
                        "<p>" +
                        "<b>1.</b> A side has only one service.\n" +
                        "<br>" +
                        "<b>2.</b> The service passes consecutively to the players as shown in the diagram.At the beginning of the game and when the score is even, the server serves from the right service court. When it is odd, the server serves from the left court.\n" +
                        "<br>" +
                        "<b>3.</b> If the serving side wins a rally, the serving side scores a point and the same server serves again from the alternate service court.\n" +
                        "<br>" +
                        "<b>4.</b> If the receiving side wins a rally, the receiving side scores a point. The receiving side becomes the new serving side.\n" +
                        "<br>" +
                        "<b>5.</b> The players do not change their respective service courts until they win a point when their side is serving.\n" +
                        "</p>" +
                        "</BODY></HTML>");
            ...
            case "Chess": {
                ...
                String chess_rules="<HTML>\n" +
                        ...
                        "\n" +
                        "<b></b>-->Draw by offer<br>\n" +
                        "<b></b>-->Draw by threefold repetition<br>\n" +
                        "<b></b>-->50-move rule<br>\n" +
                        "<b></b>-->Stalemate<br>\n" +
                        "<b></b>-->Impossibility of checkmate<br>\n" +
                        "\n" +
            ...
            case "Carrom": {
                ...
                String carrom_rules ="<HTML>\n" +
                        "<BODY>\n" +
                        "<p><b>1.</b> If the striker goes into the pocket, the player loses a chance and one of his\n" +
                        "\n" +
                        "pocketed pieces.<br>\n" +
                        "\n" +
                        "<b>2.</b> If a coin and the striker goes into the pocket at the same time, then player\n" +
                        "\n" +
                        "loses that particular pocketed coin and does not get a chance for pocketing it.<br>\n" +
                        "\n" +
                        "<b>3.</b> The player is not allowed to move or get up from his chair while shooting.<br>\n" +
                        "\n" +
                        "<b>4.</b> If a piece falls off from the carrom board, it should be placed in the centre.<br>\n" +
                        "\n" +
                        "<b>5.</b> Only the players&#39; wrist is allowed to touch the carrom board and not any other\n" +
                        "\n" +
                        "part of the body or hand.<br>\n" +
                        "\n" +
                        "<b>6.</b> Players are not allowed to change sides once the game has begun.<br>\n" +
                        "\n" +
                        "<b>7.</b> If the striker fails to leave both the lines, i.e. does not move in a single strike,\n" +
                        "\n" +
                        "the player gets 3 chances before he loses his turn.<br>\n" +
                        "<b>8.</b> The thumb can be used for backward shots \n"+
                        "</p>\n" +
                        "</BODY></HTML>";
            ...
            case "Tug Of War": {
                ...
                String tugofwarrules = "<HTML><BODY>" +
                        "<b>1.</b> No. of players will be 8 (5 boys and 3 girls).\n<br>" +
            ...
            case "Cricket": {
                ...
                String cricketrules = "<HTML><BODY>" +
                        "<b> Rules for student matches.\n\n</b><br><br>" +
                        "<b>1.</b> Match will be of 3 overs per side.\n<br>" +
                        "<b>2.</b> There will be 6 players per side which includes 4 boys and 2 girls.\n<br>" +
                        "<b>3.</b> 1 over shall be declared as power play by batting side,there should be atleast 1 girl in power play at any of the end.\n<br>" +
                        "<b>4.</b> Boys can hit 6 runs only in power play over,in other overs it shall declared as out.\n<br>" +
                        "<b>5.</b> Final and semi-finals will be of 4 over(1 power play)\n<br>" +
                        "<b>6.</b> There is no restrictions for girls in non power play overs\n<br>" +
                        "<b>7.</b> Bowling should be underarm for girls and ball bowled above waist height shall be given as no ball followed by free hit.\n<br>" +
                        "<b>8.</b> 2 tip ball is allowed for girl 3 tip ball will be declared as dead ball.\n<br>" +
                        "<b>9.</b> Eight runs rule will be explained during starting of match.\n<br>" +
                        "<b>10.</b> Only a girl bowler can ball overarm ball to girl.\n<br>" +
                        "<b>11.</b> Team if not arrived within 10 minutes after scheduled match time will be disqualified.\n<br>" +
                        "<b>12.</b> Umpire's decision is final.\n<br>" +
                        "<b>13.</b> All other international rules are applicable.\n<br>" +
                        "\n<br>" +
                        "\n<br>" +

                        "<b> Faculty matches\n</b><br><br>" +
                        "\n" +
                        "<b>1.</b> 11 players per side.\n<br>" +
                        "<b>2.</b> 6 over inning per side.\n<br>" +
                        "<b>3.</b> There will be no power play.\n<br>" +
                        "<b>4.</b> All international common rules are applicable(leg before wicket is not included).\n<br>" +
                        "<b>5.</b> Final will be of 8 overs.<br>" +
                        "</BODY></HTML>";
            ...
            case "Football": {
                ...
                String football_rules ="<HTML>\n" +
                        "<BODY>\n" +
                        "<p>\n" +
                        "<b>1.</b> Each Team Consist Of 7 Players (Boys) And 5 Players (Girls).<br>\n" +
                        "\n" +
                        "                       <b>2.</b> For Boys Game 6 Players Will Be Playing With One Subsitute On Bench.<br>\n" +
                        "\n" +
                        "                       <b>3.</b> For Girls Game 5 Players Will Be Playing.<br>\n" +
                        "                        \n" +
                        "                        <b>4.</b> Hockey Size Goal Post Will Be there.<br>\n" +
                        "\n" +
                        "                       <b>5.</b> The Entire Team Member Must Be In Proper Kit With Shin Pads.<br>\n" +
                        "\n" +
                        "                       <b>6.</b> All The Team Member Must Has Same Colour Jersey And The Colour Must Be Specified To Officials Prior To Match.<br>\n" +
                        "\n" +
                        "                        <b>7.</b> Match Will Be Played In Two Half With 15 Minutes Each For Boys And 10 Minutes Each For Girls .duration Can Be Altered If Situation Demands By Management And Officials.<br>\n" +
                        "                        \n" +
                        "                       <b>8.</b> In Case Of Draw No Extra Time Will Be There And Winners Will Be Decided By Penalty Shootouts.<br>\n" +
                        "                        <b>9.</b> Team Has To Report On The Field 20 Minutes Prior To There Match.<br>\n" +
                        "\n" +
                        "                        <b>10.</b> Any Misconduct On The Field Will Lead To Disqualification Of The Team.<br>\n" +
                        "                        \n" +
                        "                        <b>11.</b> No Player Can Play From Two Teams, If Found Both The Teams will Be Disqualified.<br>\n" +
                        "\n" +
                        "                        <b>12.</b> Refree Decision Is Final .<br>\n" +
                        "\n" +
                        "                        <b>13.</b> All Other Rules According To FIFA.<br>\n" +
                        "</p>\n" +
                        "</BODY></HTML>";
            ...
            case "Volleyball": {
                ...
                String volleyball_rule="<HTML>\n" +
                        "<BODY>\n" +
                        "<p>\n" +
                        "<b>1.</b> Team has 6 players on the court.<br>\n" +
                        "<b>2.</b> 3 players are front row players and 3 of them are back row players.<br>\n" +
                        "\n" +
                        "<b>Contacts:</b><br>\n" +
                        "<b>1.</b> Each team is allowed to have maximum of three touches before hitting the ball over the net.<br>\n" +
                        "<b>2.</b> Same player can not hit the ball twice in a row.<br>\n" +
                        "\n" +
                        "<b>Antennas:</b><br>\n" +
                        "<b>1.</b> It is ALLOWED to play the ball off the net. It is a fault, if the ball contacts net outside antennas.<br>\n" +
                        "<b>2.</b> The ball has to travel between the antennas when flying to the other side of the net.<br>\n" +
                        "\n" +
                        "<b>In or Out?</b><br>\n" +
                        "<b>1.</b> Referee calls the ball “IN”, if any part of it hits the lines. (Imagine the ball is painted. If the ball left a mark that touches the lines, the ball is judged IN).<br>\n" +
                        "<b>2.</b> Referee calls the ball in if any part of it hits the lines.<br>\n" +
                        "<b>3.</b> Ball is ruled OUT, if the ball lands outside the boundary lines (without touching the opponent)<br>\n" +
                        "<b>4.</b> The ball hits the antenna any of the net or cables outside the antennas.<br>\n" +
                        "\n" +
                        "<b>Contacting the Ball:</b><br>\n" +
                        "<b>1.</b> Players are NOT allowed to catch, hold or throw the ball.<br>\n" +
                        "<b>2.</b> Players are NOT allowed to hit or block the opponents serve.<br>\n" +
                        "<b>3.</b> Attacking ball which is coming over the net is ILLEGAL, if it has NOT broken the plane of the net.<br>\n" +
                        "<b>4.</b> In other words the player is ALLOWED to swing the ball when it breaks the plane of the net.<br>\n" +
                        "</p>\n" +
                        "</BODY></HTML>";
            ...
            case "Fun Games": {
                ...
                String fun_games_rule="<HTML>\n" +
                        ...
                        "\n" +
                        "<b>1.</b> DART -- Each participant is allowed to throw 5 darts on the DartBoard\n" +
                        "and the one with the highest score will win the game.<br>\n" +
                        "\n" +
                        "<b>2.</b> 3 SHOTS -- Each participant is allowed to take 3 shots on the castle of cups\n" +
                        "from their opposite hands.\n" +
                        "The participant with the higher number of down cups will win\n" +
                        "the game.<br>\n" +
                        "\n" +
                        "<b>3.</b> BEAT THE TIME -- Each participant has to shuffle a pack of 20 cups in a queue\n" +
                        "\n" +
                        ...
                        "winner.<br>\n" +
                        "\n" +
                        "<b>4.</b> RING TOSS -- Each participant is allowed to throw 3 rings on the cones of\n" +
                        "two different colors.\n" +
                        "After picking up the color they have to aim for the cones of\n" +
                        "the same color and the points will be awarded according to\n" +
                        " that." +
                        "</BODY></HTML>";
            ...
            case "Shot Put": {
                ...
                String shotput_rules="<HTML>\n" +
                        "<BODY>\n" +
                        "<p><b>1.</b>Competitors take their throw from inside a (7 feet) in diameter, with a toe\n" +
                        "\n" +
                        "board approximately 4&quot; high at the front of the circle.<br> <b>2.</b> The shot must land\n" +
                        "\n" +
                        "within an angle of approximately 30 degrees.<br> <b>3.</b> The athlete must rest the\n" +
                        "\n" +
                        " shot in between the neck and shoulder and keep it tight to the neck\n" +
                        "\n" +
                        "while throwing.<br> <b>4.</b> At the end of the throw, the thrower must push the\n" +
                        "\n" +
