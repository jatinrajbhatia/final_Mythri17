...
public class ViewAllFixtures extends AppCompatActivity {
...
*/
    ...
    public void init(){
        ...
        new GetFixedMatch().execute(gname,round, ggen, gtype);
    ...
    public class GetFixedMatch extends AsyncTask<String, Void, Integer> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(ViewAllFixtures.this, "Please wait...", "Fetching data...", true);
        }
        ...
        protected Integer doInBackground(String... params) {
            ...
            param.put("win", params[1]);
            param.put("gtype", params[3]);
            param.put("ggen", params[2]);
            param.put("myth","3000");
            JSONObject jsonObject;

            try {
                jsonObject = m_ServiceAccess.convertJSONString2Obj(m_ServiceAccess.getJSONStringWithParam_POST(Common.SERVICE_ADMIN_ALL_FIXTURES, param));
        ...
        protected void onPostExecute(Integer result) {
            ...
            if(result == 1){
                RVAdapter adapter = new RVAdapter(team_infoList, ViewAllFixtures.this);
                rv.setAdapter(adapter);
                rv.invalidate();
            }else{
                Toast.makeText(ViewAllFixtures.this,"Oops!! Check your internet connection",Toast.LENGTH_SHORT).show();
            }
        }
    }
